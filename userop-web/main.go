...
import (
	...
	"LFshop-api/userop-web/initialize"
	"LFshop-api/userop-web/utils"
	"LFshop-api/userop-web/utils/register/consul"
	myvalidator "LFshop-api/userop-web/validator"
	"fmt"
	"os"
	"os/signal"
	"syscall"
...
func main() {
	...
	if err != nil {
		zap.S().Panic("userop-web服务注册失败:", err.Error())
	}
