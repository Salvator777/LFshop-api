...
func List(ctx *gin.Context) {
	// 看是否是管理员，jwt校验已经把这两个封装好了，claim是payload部分，用户的一些信息
...
func New(ctx *gin.Context) {
	...
	rsp, err := global.OrderSrvClient.CreateOrder(ginCtx, &proto.OrderRequest{
...
func Detail(ctx *gin.Context) {
	...
	reMap["phone"] = rsp.OrderInfo.Phone
