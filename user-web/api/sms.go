...
func SendSms(ctx *gin.Context) {
	...
	request.QueryParams["PhoneNumbers"] = sendSmsForm.Phone             //手机号
	request.QueryParams["SignName"] = "灵风乐购"                            //阿里云验证过的项目名 自己设置
	request.QueryParams["TemplateCode"] = "SMS_471500340"               //阿里云的短信模板号 自己设置
	...
	rdb.Set(sendSmsForm.Phone, smsCode, time.Duration(global.ServerConfig.RedisInfo.Expire)*time.Second)
